...
<body class="bg-[#F4F8F2] font-sans relative pb-20">
    ...
    <section class="relative bg-green-800 text-white py-16">
        ...
        <div class="relative max-w-6xl mx-auto px-6 text-left">
            ...
            <p class="text-lg font-medium">
                Klik tombol untuk membuka popup pembayaran Midtrans.
            </p>
        </div>
    </section>
    ...
    <section class="max-w-6xl mx-auto px-6 mt-10">
        <div class="flex items-center justify-center space-x-6 text-sm font-medium text-gray-600">
            ...
            <div class="flex items-center space-x-2">
                <div class="w-6 h-6 rounded-full bg-green-600 text-white flex items-center justify-center text-xs font-semibold">2</div>
        ...
        <div class="bg-white shadow-md rounded-2xl p-8 flex-1">
            ...
            <div class="bg-green-50 border border-green-100 rounded-xl p-4 text-sm text-gray-700">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="font-bold text-green-900">Pembayaran lewat Midtrans</p>
                        <p class="text-xs text-gray-600 mt-1">
                            Setelah klik tombol, popup Midtrans akan muncul. Kamu bisa pilih metode pembayaran di sana.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:w-1/3">
            <div class="bg-white shadow-md rounded-2xl p-6 sticky top-24 border border-gray-50">
                ...
                <div class="space-y-4 text-gray-700">
                    <div class="border-b border-gray-100 pb-4">
                        <div class="flex justify-between items-start mb-2">
                            <span class="font-bold text-gray-800 text-lg">
                                Paket {{ $paketOption->category->nama_kategori }}
                            </span>
                        </div>
                    ...
                    {{-- Rincian biaya tanpa diskon/voucher --}}
                    ...
                    <div class="border-t border-gray-200 pt-4 flex justify-between items-center mt-2">
                        ...
                        <span class="font-extrabold text-[#1F5A34] text-xl">
                            Rp {{ number_format($paketOption->harga, 0, ',', '.') }}
                        </span>
                    </div>
                </div>

                <button id="btn-pay" onclick="openMidtrans()"
                    ...
                    Bayar Sekarang <i class="fas fa-wallet text-sm"></i>
                </button>
    ...
    <script>
        function openMidtrans() {
            ...
            if (!token) {
                alert('Snap token kosong. Pastikan backend membuat snap token dan mengirimkannya ke view.');
                return;
            }

            // optional: disable tombol biar ga double click
