...
<html lang="id">
  ...
  <body class="bg-green-900 font-sans relative min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center px-4 py-16 relative z-10">
      ...
      >
        ...
        <div class="flex justify-center gap-6">
          <a
            href="{{ url('/') }}"
            class="bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-medium rounded-full px-8 py-2.5 transition-all shadow-sm"
          >
            Home
          </a>
