        ...
        <form id="orderForm" class="space-y-6" method="POST" action="{{ route('paket.payment') }}">
          ...
          <div class="hidden">
            ...
            <div class="grid grid-cols-3 gap-3">
              <button type="button" class="py-3 border border-gray-300 rounded-xl text-gray-700 font-semibold bg-gray-50 hover:bg-gray-100 transition">Transfer</button>
              <button type="button" class="py-3 border border-gray-300 rounded-xl text-gray-700 font-semibold bg-gray-50 hover:bg-gray-100 transition">QRIS</button>
              <button type="button" class="py-3 border border-gray-300 rounded-xl text-gray-700 font-semibold bg-gray-50 hover:bg-gray-100 transition">Kartu Kredit</button>
            </div>
          </div>
          ...
          <div class="hidden">
            ...
            <div class="flex gap-3">
              <input type="text" placeholder="KODEPROMO" class="flex-1 border border-gray-300 rounded-lg p-3 placeholder-gray-400 focus:ring-2 focus:ring-green-500 focus:outline-none"/>
              <button type="button" class="px-5 py-3 bg-gray-100 border border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-200 transition">Terapkan</button>
            </div>
          </div>
