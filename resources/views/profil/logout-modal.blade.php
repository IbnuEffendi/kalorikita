<div id="logout-modal" class="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 hidden">
    <div class="bg-white rounded-2xl shadow-lg p-8 w-full max-w-sm text-center">
        ...
        <p class="text-gray-600 mb-6">Anda harus masuk kembali untuk mengakses dashboard Anda.</p>
        ...
        <div class="flex justify-center gap-4">
            ...
            <button id="ya-keluar-btn" class="flex-1 rounded-full bg-green-800 px-6 py-2 text-sm font-semibold text-white hover:bg-green-700 transition-all">
                Ya, Keluar
            </button>
        </div>
    </div>
