    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="w-3/4 bg-green-800 p-10 overflow-y-auto relative">
            ...
            <div class="relative z-10">
                <h1 class="text-3xl font-bold text-white mb-8">Selamat Datang!</h1>
                    ...
                    <section class="bg-white p-8 rounded-2xl shadow-lg">
                        ...
                        <div class="flex flex-col md:flex-row items-start gap-8">
                            ...
                            <div class="w-full md:w-1/3 flex flex-col items-center">
                                <img id="foto-profil-preview" src="{{ asset('asset/default-profil.png') }}" class="w-32 h-32 rounded-full object-cover border-4 border-gray-200">
